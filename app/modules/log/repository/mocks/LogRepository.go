...
import (
	...
	payload "github.com/adamnasrudin03/go-template/app/modules/log/payload"
)
...
func (_m *LogRepository) GetList(ctx context.Context, params payload.ListLogReq) ([]models.Log, error) {
	...
	var r0 []models.Log
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, payload.ListLogReq) ([]models.Log, error)); ok {
		return rf(ctx, params)
	}
	if rf, ok := ret.Get(0).(func(context.Context, payload.ListLogReq) []models.Log); ok {
		r0 = rf(ctx, params)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, payload.ListLogReq) error); ok {
		r1 = rf(ctx, params)
	} else {
		r1 = ret.Error(1)
	}
